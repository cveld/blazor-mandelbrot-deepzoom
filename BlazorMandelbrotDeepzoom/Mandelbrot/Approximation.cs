...
public class Approximation {
	...
	protected double mDxn;
	protected double mDxni;
	
	protected int gCount_with_perturbation;
	...
	public void SetScreenOffsetFromCentre( float x, float y)
	{
	...
	//
	public void CalculateApproximation( double aSdx, double aSdxi,  double[] rDx )
	{
		double sxsq,sxsqi;
		double sxcu,sxcui;
	...
	//
	public int CalculateIterations(Details aDetails, float aScreen_delta_x, float aScreen_delta_y)
	{
	...
	protected void Translate(Approximation aOriginal, float aScreen_dx, float aScreen_dy)
	{
