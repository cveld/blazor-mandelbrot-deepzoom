...
*/
    ...
    public class RoundingMode
    {
         ...
         */
        public static RoundingModeEnum valueOf(int rm)
        {
            switch (rm)
            {

                case BigDecimal.ROUND_UP:
                    return RoundingModeEnum.UP;

                case BigDecimal.ROUND_DOWN:
                    return RoundingModeEnum.DOWN;

                case BigDecimal.ROUND_CEILING:
                    return RoundingModeEnum.CEILING;

                case BigDecimal.ROUND_FLOOR:
                    return RoundingModeEnum.FLOOR;

                case BigDecimal.ROUND_HALF_UP:
                    return RoundingModeEnum.HALF_UP;

                case BigDecimal.ROUND_HALF_DOWN:
                    return RoundingModeEnum.HALF_DOWN;

                case BigDecimal.ROUND_HALF_EVEN:
                    return RoundingModeEnum.HALF_EVEN;

                case BigDecimal.ROUND_UNNECESSARY:
                    return RoundingModeEnum.UNNECESSARY;
