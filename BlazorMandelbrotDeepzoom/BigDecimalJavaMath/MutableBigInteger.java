...
class MutableBigInteger {
     ...
     */
    static readonly int KNUTH_POW2_THRESH_LEN = 6;
     ...
     */
    static readonly int KNUTH_POW2_THRESH_ZEROS = 3;
     ...
     * greater than {@code b}.
     */
    readonly int compare(MutableBigInteger b) {
        int blen = b.intLen;
        if (intLen < blen)
            return -1;
        if (intLen > blen)
     ...
     * from divide().
     */
    readonly int compareHalf(MutableBigInteger b) {
        int blen = b.intLen;
        int len = intLen;
        if (len <= 0)
            return blen <= 0 ? 0 : -1;
